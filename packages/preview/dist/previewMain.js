...
const init = newComponent => {
    dist_3(ComponentId, newComponent);
    new Vue({
        el: '#app',
...
const notExists = () => !Component;
/**
 * updates the component and its state
 * @param newComponent
 */
const reload = newComponent => {
    if (notExists()) {
        init(newComponent);
        return;
    }
    dist_6(ComponentId, newComponent);
    Component = newComponent;
};
/**
 ...
 * @param newComponent
 */
const rerender = newComponent => {
    if (notExists()) {
        init(newComponent);
        return;
    }
    dist_5(ComponentId, newComponent);
    Component = newComponent;
};
...
//# sourceMappingURL=previewMain.js.map
